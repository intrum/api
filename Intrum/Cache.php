...
class Cache
{
    ...
    */
    ...
    {
        file_put_contents($this->folder . "/{$key}.cache", serialize($data));
    }
    ...
    public function pop($key)
    {
        ...
        if (file_exists($file) and (time() - filemtime($file)) <= $this->expire) return unserialize(file_get_contents($file));
